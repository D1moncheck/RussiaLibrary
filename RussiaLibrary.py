...
def babushka():
    msg = random.choice(('Никаких аргументов, бабушка всегда права!', 'От интернетов тупым станешь! - © Бабушка', 'Внучок, как зайти в одноклассники без интернета?', 'Бежим покупать 50 килограмм гречи!'))
    print(msg)

def gopnik():
    msg = random.choice(('Есть мобила позвонить?', 'Закинь пару соток на баланс по братски', 'Семки есть?', 'Чё ты нам тут затираешь?'))
    print(msg)
